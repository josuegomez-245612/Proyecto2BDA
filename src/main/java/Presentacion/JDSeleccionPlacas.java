...
public class JDSeleccionPlacas extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDSeleccionPlacas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDSeleccionPlacas dialog = new JDSeleccionPlacas(new javax.swing.JFrame(), true);

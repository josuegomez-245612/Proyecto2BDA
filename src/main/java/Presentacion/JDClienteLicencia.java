 ...
 * @author JOSUE GOMEZ
 */
public class JDClienteLicencia extends javax.swing.JDialog {
JDRenovarLicencia rl;
JDRegistroLicencia registroLicencia;
    /**
     * Creates new form JDClienteLicencia
     */
    public JDClienteLicencia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Cliente registrado para licencia");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDClienteLicencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDClienteLicencia dialog = new JDClienteLicencia(new javax.swing.JFrame(), true);

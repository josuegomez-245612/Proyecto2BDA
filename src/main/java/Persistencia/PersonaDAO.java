...
public class PersonaDAO implements IPersonaDAO {
    ...
    public boolean insercionMasivaPersonas() {
        if (cargarTodasPersonas().size() >= 15) {
            ...
            String[] apellidosMaternos = {"Soto", "Mora", "Chad", "God", "777", "Sanchez", "Garza", "Cota", "Compa", "coppelHater", "maritoOO", "JokerMain", "gymbro", "DairyQueen", "ProTools", "Kikin", "Soto", "Cafelover", "DComics", "hola", "ESQUIZOFRENICO", "Rubius"};
